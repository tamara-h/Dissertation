...
To choose the models to compare, we will take the top models compared in previous sentiment analysis work \cite{towardsDS} and see which can work best in this situation. \todo{unsure how to expand on this without repeating information from the lit review or the results}
